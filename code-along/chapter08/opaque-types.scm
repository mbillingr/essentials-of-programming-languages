...
(define (type-of exp tenv)
  (cases expression exp
    ...
    (let-exp (var exp1 body)
      (let ((ty1 (type-of exp1 tenv)))
        (type-of body (extend-tenv var (expand-type ty1 tenv) tenv))))
    (proc-exp (var var-type body)
      (let ((result-type (type-of body (extend-tenv var (expand-type var-type tenv) tenv))))
    ...
    (letrec-exp (p-result-type p-name b-var b-var-type p-body letrec-body)
      (let ((tenv-for-letrec-body
        ...
        (let ((p-body-type
                (type-of p-body
                  (extend-tenv b-var (expand-type b-var-type tenv) tenv-for-letrec-body))))
