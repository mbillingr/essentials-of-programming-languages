...
; The answer to the question of this exercise is 2 (see last test case) because that's the value
; of a when p is called.
...
(assert-eval
  "let a = 3 in let p = proc (z) a in let f = proc (a) (p 0) in let a = 5 in (f 2)"
  (num-val 2))
